...
export const WidthAnimator = View.styleable((props, ref) => {
    ...
    <View ref={ref} animation="fast" enterStyle={{ opacity: 0 }} exitStyle={{ opacity: 0 }} height={height} overflow="hidden" width={open ? visibleWidth : 0} {...rest}>
      <View position="absolute" onLayout={onLayout}>
        {children}
      </View>
    </View>);
});
//# sourceMappingURL=WidthAnimator.jsx.map