...
import { ButtonText, getTokenValue, spacedChildren, styled, Text, useGetThemedIcon, useProps, withStaticProperties, wrapChildrenInText, XStack, } from 'tamagui';
...
const ButtonComponent = CustomButtonFrame.styleable((props, ref) => {
    ...
    return (<CustomButtonFrame ref={ref} onPressIn={undefined} // or remove this line entirely if onPressIn is not needed
     {...buttonProps}/>);
});
...
function useButton(propsIn) {
    ...
    icon, iconAfter, separator, color, ...buttonFrameProps } = propsIn;
    ...
    const contents = wrapChildrenInText(CustomButtonText, 
    ...
    const inner = spacedChildren({
        separator,
        direction: propsActive.flexDirection === 'column' || propsActive.flexDirection === 'column-reverse'
            ? 'vertical'
            : 'horizontal',
