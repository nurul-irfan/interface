...
export const [AlertCircle, AnimatedAlertCircle] = createIcon({
    name: 'AlertCircle',
    getIcon: (props) => (<Svg fill="none" viewBox="0 0 22 22" {...props}>
      <Path d="M11 21a10 10 0 1 0 0-20 10 10 0 0 0 0 20Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
//# sourceMappingURL=AlertCircle.jsx.map