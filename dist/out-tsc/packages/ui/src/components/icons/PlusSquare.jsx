...
export const [PlusSquare, AnimatedPlusSquare] = createIcon({
    ...
    getIcon: (props) => (<Svg viewBox="0 0 20 20" fill="none" {...props}>
      ...
      <Path d="M10 6.66663V13.3333" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <Path d="M6.66663 10H13.3333" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>),
});
//# sourceMappingURL=PlusSquare.jsx.map