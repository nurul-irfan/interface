...
export const [SeedPhraseIcon, AnimatedSeedPhraseIcon] = createIcon({
    ...
    getIcon: (props) => (<Svg viewBox="0 0 18 17" fill="none" {...props}>
      ...
      <Defs>
        <LinearGradient id="paint0_linear_726_11704" x1="1.41146" y1="5.02273" x2="3.41039" y2="10.9584" gradientUnits="userSpaceOnUse">
          <Stop stopColor="#FF57EE"/>
          <Stop offset="0.9375" stopColor="#FFB8A2"/>
        </LinearGradient>
        <LinearGradient id="paint1_linear_726_11704" x1="10.9427" y1="13.5227" x2="12.9416" y2="19.4584" gradientUnits="userSpaceOnUse">
          <Stop stopColor="#FF57EE"/>
          <Stop offset="0.9375" stopColor="#FFB8A2"/>
        </LinearGradient>
      </Defs>
...
//# sourceMappingURL=SeedPhraseIcon.jsx.map