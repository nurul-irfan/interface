...
export const [UniswapX, AnimatedUniswapX] = createIcon({
    name: 'UniswapX',
    getIcon: (props) => (<Svg viewBox="0 0 10 14" fill="none" {...props}>
      <Defs>
        <LinearGradient id="uniswap_x_gradient" x1="-10.1807" y1="-12.0006" x2="10.6573" y2="-11.6017" gradientUnits="userSpaceOnUse">
...
//# sourceMappingURL=UniswapX.jsx.map