...
export const [PolygonscanLogoDark, AnimatedPolygonscanLogoDark] = createIcon({
    name: 'PolygonscanLogoDark',
    getIcon: (props) => (<Svg viewBox="0 0 256 256" fill="none" {...props}>
...
//# sourceMappingURL=PolygonscanLogoDark.jsx.map