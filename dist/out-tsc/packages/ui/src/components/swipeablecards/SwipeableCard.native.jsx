...
export function SwipeableCard({ children, stackIndex, cardHeight, disableSwipe, onPress, onSwiped, onLayout, }) {
    ...
    const pan = Gesture.Pan()
        ...
        if (shouldDismissCard) {
            panOffset.value = withSpring((translationX < 0 ? -1 : 1) * screenWidth, { restDisplacementThreshold: screenWidth / 5, restSpeedThreshold: 100 }, () => runOnJS(onSwiped)());
        }
        else {
...
//# sourceMappingURL=SwipeableCard.native.jsx.map