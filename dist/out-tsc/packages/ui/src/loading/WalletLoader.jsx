...
export function WalletLoader({ opacity }) {
    return (<Flex row alignItems="center" borderColor="$neutral3" borderRadius="$rounded20" borderWidth={1} justifyContent="flex-start" opacity={opacity} overflow="hidden" px="$spacing16" py="$spacing16" sentry-label="WalletLoader">
...
//# sourceMappingURL=WalletLoader.jsx.map