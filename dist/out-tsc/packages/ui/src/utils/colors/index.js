...
const blackAndWhiteSpecialCase = new Set([
    // QNT
...
export function useExtractedColors(imageUrl, fallback = 'accent1', cache = true) {
    const sporeColors = useSporeColors();
    const getImageColors = useCallback(async () => getExtractedColors(imageUrl, sporeColors[fallback].val, cache), [imageUrl, fallback, cache, sporeColors]);
...
function getSpecialCaseTokenColor(imageUrl, isDarkMode) {
    ...
    return (_a = SPECIAL_CASE_TOKEN_COLORS[imageUrl]) !== null && _a !== void 0 ? _a : null;
}
/**
...
export function useExtractedTokenColor(imageUrl, tokenName, backgroundColor, defaultColor) {
    ...
    const { foreground } = useColorSchemeFromSeed(tokenName !== null && tokenName !== void 0 ? tokenName : '');
    useEffect(() => {
        if (!colorsLoading) {
    ...
    if (isSVGUri(imageUrl)) {
        ...
        return { tokenColor: (_a = sporeColors.neutral1) === null || _a === void 0 ? void 0 : _a.val, tokenColorLoading: false };
    }
    if (!imageUrl) {
...
var LOGOLESS_COLORS;
(function (LOGOLESS_COLORS) {
    LOGOLESS_COLORS["PINK"] = "PINK";
    LOGOLESS_COLORS["ORANGE"] = "ORANGE";
    LOGOLESS_COLORS["YELLOW"] = "YELLOW";
    LOGOLESS_COLORS["GREEN"] = "GREEN";
    LOGOLESS_COLORS["TURQUOISE"] = "TURQUOISE";
    LOGOLESS_COLORS["CYAN"] = "CYAN";
    LOGOLESS_COLORS["BLUE"] = "BLUE";
    LOGOLESS_COLORS["PURPLE"] = "PURPLE";
})(LOGOLESS_COLORS || (LOGOLESS_COLORS = {}));
