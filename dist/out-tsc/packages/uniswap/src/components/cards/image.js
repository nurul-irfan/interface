...
export function CardImage({ uri }) {
    return (_jsx(Image, { alignSelf: "center", position: "absolute", resizeMode: "cover", source: {
            ...
            uri,
        }, left: 0, top: -(CardImageGraphicSizeInfo.height * CardImageGraphicSizeInfo.ratio * CardImageGraphicSizeInfo.topOffsetRatio) }));
}
