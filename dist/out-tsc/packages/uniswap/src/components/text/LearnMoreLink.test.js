...
describe(LearnMoreLink, () => {
    it('renders without error', () => {
        const tree = renderWithProviders(_jsx(LearnMoreLink, { url: "https://example.com" }));
        expect(tree).toMatchSnapshot();
    });
    it('renders a learn more link', () => {
        const { queryByText } = renderWithProviders(_jsx(LearnMoreLink, { url: "https://example.com" }));
        const learnMoreLink = queryByText('Learn more');
        expect(learnMoreLink).toBeTruthy();
    });
    it('calls openUri when pressed', () => {
        const { getByText } = renderWithProviders(_jsx(LearnMoreLink, { url: "https://example.com" }));
...
//# sourceMappingURL=LearnMoreLink.test.js.map