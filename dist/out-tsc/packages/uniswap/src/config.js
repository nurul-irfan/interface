...
import { APPSFLYER_API_KEY, APPSFLYER_APP_ID, DATADOG_CLIENT_TOKEN, DATADOG_PROJECT_ID, FIREBASE_APP_CHECK_DEBUG_TOKEN, INFURA_KEY, ONESIGNAL_APP_ID, OPENAI_API_KEY, QUICKNODE_ARBITRUM_RPC_URL, QUICKNODE_ASTROCHAIN_SEPOLIA_RPC_URL, QUICKNODE_AVAX_RPC_URL, QUICKNODE_BASE_RPC_URL, QUICKNODE_BLAST_RPC_URL, QUICKNODE_BNB_RPC_URL, QUICKNODE_CELO_RPC_URL, QUICKNODE_MAINNET_RPC_URL, QUICKNODE_MONAD_TESTNET_RPC_URL, QUICKNODE_OP_RPC_URL, QUICKNODE_POLYGON_RPC_URL, QUICKNODE_SEPOLIA_RPC_URL, QUICKNODE_WORLDCHAIN_RPC_URL, QUICKNODE_ZKSYNC_RPC_URL, QUICKNODE_ZORA_RPC_URL, SENTRY_DSN, SIMPLEHASH_API_KEY, SIMPLEHASH_API_URL, STATSIG_PROXY_URL, TRADING_API_KEY, UNISWAP_API_KEY, WALLETCONNECT_PROJECT_ID, } from 'react-native-dotenv';
...
const _config = {
    ...
    walletConnectProjectId: process.env.REACT_APP_WALLET_CONNECT_PROJECT_ID || process.env.WALLETCONNECT_PROJECT_ID || WALLETCONNECT_PROJECT_ID,
    ...
    quicknodeAvaxRpcUrl: process.env.REACT_APP_QUICKNODE_AVAX_RPC_URL || process.env.QUICKNODE_AVAX_RPC_URL || QUICKNODE_AVAX_RPC_URL,
    quicknodeBaseRpcUrl: process.env.REACT_APP_QUICKNODE_BASE_RPC_URL || process.env.QUICKNODE_BASE_RPC_URL || QUICKNODE_BASE_RPC_URL,
    quicknodeBlastRpcUrl: process.env.REACT_APP_QUICKNODE_BLAST_RPC_URL || process.env.QUICKNODE_BLAST_RPC_URL || QUICKNODE_BLAST_RPC_URL,
    quicknodeBnbRpcUrl: process.env.REACT_APP_QUICKNODE_BNB_RPC_URL || process.env.QUICKNODE_BNB_RPC_URL || QUICKNODE_BNB_RPC_URL,
    quicknodeCeloRpcUrl: process.env.REACT_APP_QUICKNODE_CELO_RPC_URL || process.env.QUICKNODE_CELO_RPC_URL || QUICKNODE_CELO_RPC_URL,
    quicknodeMonadTestnetRpcUrl: process.env.REACT_APP_QUICKNODE_MONAD_TESTNET_RPC_URL ||
        process.env.QUICKNODE_MONAD_TESTNET_RPC_URL ||
        QUICKNODE_MONAD_TESTNET_RPC_URL,
    quicknodeOpRpcUrl: process.env.REACT_APP_QUICKNODE_OP_RPC_URL || process.env.QUICKNODE_OP_RPC_URL || QUICKNODE_OP_RPC_URL,
    ...
    quicknodeZoraRpcUrl: process.env.REACT_APP_QUICKNODE_ZORA_RPC_URL || process.env.QUICKNODE_ZORA_RPC_URL || QUICKNODE_ZORA_RPC_URL,
    quicknodeZkSyncRpcUrl: process.env.REACT_APP_QUICKNODE_ZKSYNC_RPC_URL || process.env.QUICKNODE_ZKSYNC_RPC_URL || QUICKNODE_ZKSYNC_RPC_URL,
    quicknodeWorldChainRpcUrl: process.env.REACT_APP_QUICKNODE_WORLDCHAIN_RPC_URL ||
        process.env.QUICKNODE_WORLDCHAIN_RPC_URL ||
        QUICKNODE_WORLDCHAIN_RPC_URL,
    quicknodeUnichainSepoliaRpcUrl: process.env.REACT_APP_QUICKNODE_ASTROCHAIN_SEPOLIA_RPC_URL ||
    ...
    quicknodeSepoliaRpcUrl: process.env.REACT_APP_QUICKNODE_SEPOLIA_RPC_URL ||
