...
export function useIsChromeWindowFocused() {
    const [isFocused, setIsFocused] = useState(true);
    useAsyncData(useCallback(async () => {
        if (!isExtension) {
            // This hook is ignored and always returns `true` when not in the Extension.
            return undefined;
        }
        const onFocusChangedListener = async () => {
...
export function useIsChromeWindowFocusedWithTimeout(timeoutInMs) {
...
//# sourceMappingURL=useIsChromeWindowFocused.js.map