...
export function getCanonicalBridgingDappUrls(chainIds) {
    const canonicalUrls = chainIds
        .map((chainId) => {
        const chainInfo = getChainInfo(chainId);
        return (chainInfo === null || chainInfo === void 0 ? void 0 : chainInfo.bridge) ? extractBaseUrl(chainInfo.bridge) : undefined;
    })
 ...
 */
export function getBridgingDappUrls(chainIds) {
