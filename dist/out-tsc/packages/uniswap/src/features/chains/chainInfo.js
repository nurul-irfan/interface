...
import { ARBITRUM_LOGO, AVALANCHE_LOGO, BASE_LOGO, BLAST_LOGO, BNB_LOGO, CELO_LOGO, ETHEREUM_LOGO, MONAD_LOGO, OPTIMISM_LOGO, POLYGON_LOGO, UNICHAIN_SEPOLIA_LOGO, WORLD_CHAIN_LOGO, ZKSYNC_LOGO, ZORA_LOGO, } from 'ui/src/assets';
import { config } from 'uniswap/src/config';
import { CUSD_CELO, DAI, DAI_ARBITRUM_ONE, DAI_OPTIMISM, DAI_POLYGON, USDB_BLAST, USDC, USDC_ARBITRUM, USDC_AVALANCHE, USDC_BASE, USDC_BNB, USDC_CELO, USDC_OPTIMISM, USDC_POLYGON, USDC_SEPOLIA, USDC_UNICHAIN_SEPOLIA, USDC_WORLD_CHAIN, USDC_ZKSYNC, USDC_ZORA, USDT, USDT_MONAD_TESTNET, } from 'uniswap/src/constants/tokens';
...
import { arbitrum, avalanche, base, blast, bsc, celo, mainnet, optimism, polygon, sepolia, zkSync, zora, } from 'wagmi/chains';
...
export const UNIVERSE_CHAIN_INFO = {
    [UniverseChainId.Mainnet]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC, 100000000000),
    ...
    [UniverseChainId.ArbitrumOne]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_ARBITRUM, 10000000000),
    ...
    [UniverseChainId.Avalanche]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_AVALANCHE, 10000000000),
    ...
    [UniverseChainId.Base]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_BASE, 10000000000),
    ...
    [UniverseChainId.Blast]: {
        ...
        networkLayer: NetworkLayer.L2,
        pendingTransactionsRetryOptions: DEFAULT_RETRY_OPTIONS,
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDB_BLAST, 1e+22),
    ...
    [UniverseChainId.Celo]: {
        ...
        networkLayer: NetworkLayer.L1,
        pendingTransactionsRetryOptions: undefined,
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(CUSD_CELO, 1e+22),
    ...
    [UniverseChainId.MonadTestnet]: {
        ...
        backendChain: {
            chain: BackendChainId.MonadTestnet,
            backendSupported: true,
            isSecondaryChain: false,
            nativeTokenBackendAddress: undefined,
        },
        ...
        infuraPrefix: undefined,
        interfaceName: 'monad',
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDT_MONAD_TESTNET, 10000000000),
    ...
    [UniverseChainId.Optimism]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_OPTIMISM, 10000000000),
    ...
    [UniverseChainId.Polygon]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_POLYGON, 10000000000),
    ...
    [UniverseChainId.UnichainSepolia]: {
        ...
        assetRepoNetworkName: undefined,
        backendChain: {
            chain: BackendChainId.AstrochainSepolia,
            backendSupported: true,
            isSecondaryChain: false,
            nativeTokenBackendAddress: undefined,
        },
        ...
        rpcUrls: {
            [RPCType.Public]: {
                http: [config.quicknodeUnichainSepoliaRpcUrl],
            },
            [RPCType.Default]: {
                http: [config.quicknodeUnichainSepoliaRpcUrl],
            },
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_UNICHAIN_SEPOLIA, 10000000000),
    ...
    [UniverseChainId.WorldChain]: {
        ...
        backendChain: {
            chain: BackendChainId.Worldchain,
            backendSupported: true,
            isSecondaryChain: false,
            nativeTokenBackendAddress: undefined,
        },
        ...
        urlParam: 'worldchain',
        statusPage: undefined,
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_WORLD_CHAIN, 10000000000),
    ...
    [UniverseChainId.Zksync]: {
        ...
        urlParam: 'zksync',
        statusPage: undefined,
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_ZKSYNC, 10000000000),
    ...
    [UniverseChainId.Zora]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_ZORA, 10000000000),
...
export const GQL_TESTNET_CHAINS = Object.values(UNIVERSE_CHAIN_INFO)
    ...
    .map((chain) => chain.backendChain.chain)
    .filter((backendChain) => !!backendChain);
export const ALL_GQL_CHAINS = [...GQL_MAINNET_CHAINS, ...GQL_TESTNET_CHAINS];
