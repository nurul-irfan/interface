...
export function useOrderedChainIds(chainIds) {
    const serverOrderedChains = useDynamicConfigValue(DynamicConfigs.Chains, ChainsConfigKey.OrderedChainIds, ALL_CHAIN_IDS);
    return useMemo(() => {
...
//# sourceMappingURL=useOrderedChainIds.js.map