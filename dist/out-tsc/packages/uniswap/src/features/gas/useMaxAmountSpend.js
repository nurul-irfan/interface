 ...
 */
export function useMaxAmountSpend(currencyAmount, txType) {
    const minAmount = useGetMinAmount(currencyAmount === null || currencyAmount === void 0 ? void 0 : currencyAmount.currency.chainId, txType);
