...
import { Language, Locale, PLATFORM_SUPPORTED_LANGUAGES, mapDeviceLanguageToLanguage, mapLocaleToLanguage, } from 'uniswap/src/features/language/constants';
...
function* appLanguageSaga(action) {
...
function getDeviceLanguage() {
    ...
    for (const locale of deviceLocales) {
        ...
        const normalizedLanguageTag = locale.languageTag.split('-').slice(0, 2).join('-');
        ...
        const mappedLanguageFromCode = locale.languageCode;
...
function restartAppIfRTL(currentLocale) {
