...
describe('FlashbotsRpcProvider', () => {
    ...
    describe('getTransactionCount', () => {
        ...
        it('should use authenticated request for pending blocks', async () => {
            ...
            mockFetchJson.mockImplementation((connection, request) => {
                var _a;
                ...
                if (parsedRequest.method === 'eth_chainId') {
                    ...
                    expect((_a = connection.headers) === null || _a === void 0 ? void 0 : _a['X-Flashbots-Signature']).toBe(`${testAddress}:0xsignature`);
...
//# sourceMappingURL=FlashbotsRpcProvider.test.js.map