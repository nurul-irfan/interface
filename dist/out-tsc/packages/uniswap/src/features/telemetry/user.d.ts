...
export declare function setUserProperty(property: MobileUserPropertyName | ExtensionUserPropertyName | CustomUserProperties, value: UserPropertyValue, insert?: boolean): void;
