...
import { TokenProtectionWarning, getFeeColor, getFeeWarning, getShouldHaveCombinedPluralTreatment, getTokenProtectionWarning, getTokenWarningSeverity, useModalHeaderText, useModalSubtitleText, } from 'uniswap/src/features/tokens/safetyUtils';
...
describe('safetyUtils', () => {
    ...
    const mockNativeCurrency = { isNative: true };
...
//# sourceMappingURL=safetyUtils.test.js.map