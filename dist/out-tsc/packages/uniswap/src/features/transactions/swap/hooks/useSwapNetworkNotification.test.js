...
useUniswapContext.mockReturnValue({
...
describe('useSwapNetworkNotification', () => {
    ...
    it('does not show notification if input and output chain ids are the same', () => {
        const { rerender } = renderHook(({ inputChainId, outputChainId }) => useSwapNetworkNotification({ inputChainId, outputChainId }), {
            initialProps: {
...
//# sourceMappingURL=useSwapNetworkNotification.test.js.map