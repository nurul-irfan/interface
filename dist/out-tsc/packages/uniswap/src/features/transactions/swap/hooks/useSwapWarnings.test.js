...
describe(getSwapWarnings, () => {
    it('catches incomplete form errors', async () => {
        ...
        expect((_a = warnings[0]) === null || _a === void 0 ? void 0 : _a.type).toEqual(WarningLabel.FormIncomplete);
    });
    ...
    it('catches insufficient balance errors', () => {
        ...
        expect(warnings.length).toBe(1);
        expect((_a = warnings[0]) === null || _a === void 0 ? void 0 : _a.type).toEqual(WarningLabel.InsufficientFunds);
    });
...
//# sourceMappingURL=useSwapWarnings.test.js.map