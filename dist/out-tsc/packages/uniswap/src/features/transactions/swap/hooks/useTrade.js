...
import { SWAP_GAS_URGENCY_OVERRIDE, getTokenAddressForApi, toTradingApiSupportedChainId, transformTradingApiResponseToTrade, useQuoteRoutingParams, useQuoteSlippageParams, validateTrade, } from 'uniswap/src/features/transactions/swap/utils/tradingApi';
...
export function useTrade({ account, amountSpecified: amount, otherCurrency, tradeType, pollInterval, customSlippageTolerance, isUSDQuote, skip, selectedProtocols, isDebouncing, }) {
    const activeAccountAddress = account === null || account === void 0 ? void 0 : account.address;
    /***** Format request arguments ******/
    const currencyIn = tradeType === TradeType.EXACT_INPUT ? amount === null || amount === void 0 ? void 0 : amount.currency : otherCurrency;
    const currencyOut = tradeType === TradeType.EXACT_OUTPUT ? amount === null || amount === void 0 ? void 0 : amount.currency : otherCurrency;
    const currencyInEqualsCurrencyOut = currencyIn && currencyOut && areCurrencyIdsEqual(currencyId(currencyIn), currencyId(currencyOut));
    const tokenInChainId = toTradingApiSupportedChainId(currencyIn === null || currencyIn === void 0 ? void 0 : currencyIn.chainId);
    ...
    const routingParams = useQuoteRoutingParams({
        selectedProtocols,
        tokenInChainId: currencyIn === null || currencyIn === void 0 ? void 0 : currencyIn.chainId,
        tokenOutChainId: currencyOut === null || currencyOut === void 0 ? void 0 : currencyOut.chainId,
        isUSDQuote,
    });
    ...
    const requestTradeType = tradeType === TradeType.EXACT_INPUT ? TradingApiTradeType.EXACT_INPUT : TradingApiTradeType.EXACT_OUTPUT;
    ...
    const quoteRequestArgs = useMemo(() => {
        if (skipQuery) {
            return undefined;
        }
        return {
            ...
            isUSDQuote,
            swapper: activeAccountAddress !== null && activeAccountAddress !== void 0 ? activeAccountAddress : UNCONNECTED_ADDRESS,
    ...
    const pollingIntervalForChain = usePollingIntervalByChain(currencyIn === null || currencyIn === void 0 ? void 0 : currencyIn.chainId);
    const internalPollInterval = pollInterval !== null && pollInterval !== void 0 ? pollInterval : pollingIntervalForChain;
    ...
    if (errorUpdatedAt > dataUpdatedAt) {
        ...
        errorRef.current = error !== null && error !== void 0 ? error : errorRef.current;
    }
    else {
    ...
    return useMemo(() => {
        ...
        let gasEstimates;
        if ((data === null || data === void 0 ? void 0 : data.quote) && 'gasEstimates' in data.quote && data.quote.gasEstimates) {
            // Only classic quotes include gasEstimates
            const activeGasEstimate = data.quote.gasEstimates.find((e) => areEqualGasStrategies(e.strategy, activeGasStrategy));
        ...
        if (!(data === null || data === void 0 ? void 0 : data.quote) || !currencyIn || !currencyOut) {
            return {
                isLoading,
                isFetching,
                trade: null,
