...
export function useDeadlineSettings() {
    ...
    const [inputDeadline, setInputDeadline] = useState((customDeadline === null || customDeadline === void 0 ? void 0 : customDeadline.toString()) || DEFAULT_CUSTOM_DEADLINE.toString());
    ...
    const onChangeDeadlineInput = useCallback(async (value) => {
    ...
    const onFocusDeadlineInput = useCallback(() => {
...
//# sourceMappingURL=useDeadlineSettings.js.map