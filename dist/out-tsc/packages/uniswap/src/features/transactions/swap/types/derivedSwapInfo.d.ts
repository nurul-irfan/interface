...
export type DerivedSwapInfo<TInput = CurrencyInfo, TOutput extends CurrencyInfo = CurrencyInfo> = BaseDerivedInfo<TInput> & {
...
//# sourceMappingURL=derivedSwapInfo.d.ts.map