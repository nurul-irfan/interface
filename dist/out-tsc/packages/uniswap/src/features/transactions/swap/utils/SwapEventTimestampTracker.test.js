import { SwapEventTimestampTracker, SwapEventType, } from 'uniswap/src/features/transactions/swap/utils/SwapEventTimestampTracker';
describe('SwapEventTimestampTracker', () => {
    ...
    it('should get elapsed time between two events', () => {
        ...
        expect(instance.getElapsedTime(SwapEventType.FirstSwapSuccess, SwapEventType.FirstSwapAction)).toEqual(swapSuccessTime - swapActionTime);
    });
...
//# sourceMappingURL=SwapEventTimestampTracker.test.js.map