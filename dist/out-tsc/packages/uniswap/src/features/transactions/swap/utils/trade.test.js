...
export const mockPool = new Pool(UNI[UniverseChainId.Mainnet], WBTC, FeeAmount.HIGH, '2437312313659959819381354528', '10272714736694327408', -69633);
describe(requireAcceptNewTrade, () => {
    describe('ClassicTrade', () => {
        const oldTrade = new ClassicTrade({
            ...
            v3Routes: [
                {
                    routev3: new Route([mockPool], UNI[UniverseChainId.Mainnet], WBTC),
