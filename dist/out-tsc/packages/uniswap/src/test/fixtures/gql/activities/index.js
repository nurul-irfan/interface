import { ActivityType, Chain, TransactionStatus, TransactionType, } from 'uniswap/src/data/graphql/uniswap-data-api/__generated__/types-and-hooks';
import { STALE_TRANSACTION_TIME_MS } from 'uniswap/src/features/notifications/constants';
import { erc20ApproveAssetChange, erc20TokenTransferOut, erc20TransferIn, } from 'uniswap/src/test/fixtures/gql/activities/tokens';
 ...
 * Base fixtures
 */
export const assetActivity = createFixture()(() => ({
