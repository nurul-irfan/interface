...
export const currencyInfo = createFixture({
...
export const daiCurrencyInfo = createFixture()(() => currencyInfo({
    nativeCurrency: MAINNET_CURRENCY,
    logoUrl: 'https://raw.githubusercontent.com/Uniswap/assets/master/blockchains/ethereum/assets/0x6B175474E89094C44Da98b954EedeAC495271d0F/logo.png',
}));
...
export const removeSafetyInfo = (item) => {
    if (!item) {
        return item;
    }
