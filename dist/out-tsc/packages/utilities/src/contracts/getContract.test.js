...
describe('getContract', () => {
    ...
    it('should throw an error if the address is invalid', () => {
        ...
        expect(() => getContract('invalid_address', mockABI, mockProvider)).toThrow(`Invalid 'address' parameter 'invalid_address'.`);
    ...
    it('should throw an error if the address is AddressZero', () => {
        ...
        expect(() => getContract(AddressZero, mockABI, mockProvider)).toThrow(`Invalid 'address' parameter '${AddressZero}'.`);
    });
...
//# sourceMappingURL=getContract.test.js.map