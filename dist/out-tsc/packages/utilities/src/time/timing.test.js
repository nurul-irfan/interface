...
import { DEFAULT_DELAY, promiseMinDelay, promiseTimeout, useDebounceWithStatus, useInterval, useTimeout, } from 'utilities/src/time/timing';
jest.useFakeTimers();
const timedPromise = (duration, shouldResolve = true) => new Promise((resolve, reject) => setTimeout(() => (shouldResolve ? resolve('resolve') : reject(new Error('reject'))), duration));
