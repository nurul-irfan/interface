...
import { CardType, IntroCardGraphicType } from 'wallet/src/components/introCards/IntroCard';
...
export function useSharedIntroCards({ navigateToUnitagClaim, navigateToUnitagIntro, hasTokens, }) {
    ...
    const handleBridgingDismiss = useCallback((shouldNavigate) => {
        if (shouldNavigate) {
...
//# sourceMappingURL=useSharedIntroCards.js.map