...
export const { name: authSagaName, wrappedSaga: authSaga, reducer: authReducer, actions: authActions, } = createMonitoredSaga(auth, 'auth', { showErrorNotification: false, doNotLogErrors: [AuthSagaError.InvalidPassword] });
