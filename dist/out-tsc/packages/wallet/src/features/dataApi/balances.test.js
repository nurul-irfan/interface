...
import { Chain, PortfolioBalancesDocument, } from 'uniswap/src/data/graphql/uniswap-data-api/__generated__/types-and-hooks';
...
import { sortPortfolioBalances, useHighestBalanceNativeCurrencyId, usePortfolioBalances, usePortfolioCacheUpdater, usePortfolioTotalValue, 
// eslint-disable-next-line no-restricted-imports
usePortfolioValueModifiers, useSortedPortfolioBalances, useTokenBalancesGroupedByVisibility, } from 'uniswap/src/features/dataApi/balances';
...
import { ARBITRUM_CURRENCY, BASE_CURRENCY, MAINNET_CURRENCY, OPTIMISM_CURRENCY, POLYGON_CURRENCY, SAMPLE_CURRENCY_ID_1, SAMPLE_CURRENCY_ID_2, SAMPLE_SEED_ADDRESS_1, SAMPLE_SEED_ADDRESS_2, currencyInfo, daiToken, ethToken, portfolio, portfolioBalance, tokenBalance, } from 'uniswap/src/test/fixtures';
...
describe(usePortfolioValueModifiers, () => {
    ...
    const mockUserSettingsState = (overrideSettings) => ({
        ...initialUserSettingsState,
        ...overrideSettings,
    });
    const mockFavoritesState = (overrideTokensVisibility) => ({
...
describe(usePortfolioTotalValue, () => {
    ...
    it('returns total value of all balances for the specified address', async () => {
        ...
        await waitFor(() => {
            ...
            expect(result.current).toEqual({
                data: {
                    balanceUSD: (_a = Portfolio.tokensTotalDenominatedValue) === null || _a === void 0 ? void 0 : _a.value,
                    percentChange: (_c = (_b = Portfolio.tokensTotalDenominatedValueChange) === null || _b === void 0 ? void 0 : _b.percentage) === null || _c === void 0 ? void 0 : _c.value,
                    absoluteChangeUSD: (_e = (_d = Portfolio.tokensTotalDenominatedValueChange) === null || _d === void 0 ? void 0 : _d.absolute) === null || _e === void 0 ? void 0 : _e.value,
                },
                loading: false,
                networkStatus: NetworkStatus.ready,
                refetch: expect.any(Function),
...
describe(sortPortfolioBalances, () => {
    ...
    it('[testnet mode] returns native balances before everything else', () => {
        ...
        expect(result.map((t) => t.currencyInfo.currencyId)).toEqual([nativeBalances[0], nativeBalances[1], tokenBalances[1], tokenBalances[0]].map((t) => t === null || t === void 0 ? void 0 : t.currencyInfo.currencyId));
    });
    ...
    it('[testnet mode] sorts token balances by name (no name last)', () => {
        ...
        const namelessTokenBalance = {
            ...tokenBalances[1],
            currencyInfo: {
                ...(_a = tokenBalances[1]) === null || _a === void 0 ? void 0 : _a.currencyInfo,
                currency: { ...(_c = (_b = tokenBalances[1]) === null || _b === void 0 ? void 0 : _b.currencyInfo) === null || _c === void 0 ? void 0 : _c.currency, name: undefined },
            },
        };
        const result = sortPortfolioBalances({
            balances: [tokenBalances[0], namelessTokenBalance],
            isTestnetModeEnabled: true,
        });
...
describe(usePortfolioCacheUpdater, () => {
    ...
    it('updates the tokensTotalDenominatedValue field in the cache', () => {
        ...
        result.current(true, balance);
        expect(modifyMock).toHaveBeenCalledWith(expect.objectContaining({
            fields: {
