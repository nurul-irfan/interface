...
import { isWeb, useIsDarkMode } from 'ui/src';
...
export function useNFTContextMenu({ contractAddress, tokenId, owner, showNotification = false, isSpam, chainId, }) {
    ...
    const menuActions = useMemo(() => nftKey
        ? [
            ...(isWeb && chainId
                ? [
                    {
    ...
    const onContextMenuPress = useCallback(async (e) => {
        var _a, _b;
        await ((_b = (_a = menuActions[e.nativeEvent.index]) === null || _a === void 0 ? void 0 : _a.onPress) === null || _b === void 0 ? void 0 : _b.call(_a));
    }, [menuActions]);
    return { menuActions, onContextMenuPress, onlyShare: !!nftKey && !isLocalAccount };
}
//# sourceMappingURL=useNftContextMenu.js.map