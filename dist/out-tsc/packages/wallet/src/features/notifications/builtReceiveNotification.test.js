...
describe(buildReceiveNotification, () => {
    ...
    it('builds correct notification object for nft receive', () => {
        ...
        expect(buildReceiveNotification(testTransaction, account.address)).toEqual(receiveNFTNotification({
            assetType: AssetType.ERC1155,
    ...
    it('builds correct notification object for currency receive', () => {
        ...
        expect(buildReceiveNotification(testTransaction, account.address)).toEqual(receiveCurrencyTxNotification({
            address: account.address,
            chainId: testTransaction.chainId,
...
//# sourceMappingURL=builtReceiveNotification.test.js.map