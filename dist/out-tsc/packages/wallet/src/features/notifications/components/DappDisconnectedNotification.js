...
export function DappDisconnectedNotification({ notification: { hideDelay = 2000, dappIconUrl }, }) {
    ...
    return (_jsx(NotificationToast, { smallToast: true, hideDelay: hideDelay, icon: dappIconUrl ? (_jsx(UniversalImage, { uri: dappIconUrl, style: { image: { borderRadius: borderRadii.rounded8 } }, size: {
            ...
            } })) : undefined, title: t('common.text.disconnected') }));
}
//# sourceMappingURL=DappDisconnectedNotification.js.map