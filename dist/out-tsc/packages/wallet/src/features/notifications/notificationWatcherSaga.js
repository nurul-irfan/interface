...
export function* pushTransactionNotification(action) {
    var _a;
    const activeAddress = yield* select(selectActiveAccountAddress);
    const existingNotifications = yield* select((state) => makeSelectAddressNotifications()(state, activeAddress));
    ...
    if (typeInfo.type === TransactionType.Approve) {
        ...
        if ((typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.assetType) === AssetType.Currency && (typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.currencyAmountRaw)) {
            yield* put(pushNotification({
                ...baseNotificationData,
                type: AppNotificationType.Transaction,
        ...
        else if (((typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.assetType) === AssetType.ERC1155 || (typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.assetType) === AssetType.ERC721) &&
            (typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.tokenId)) {
            yield* put(pushNotification({
                ...baseNotificationData,
                type: AppNotificationType.Transaction,
                txType: TransactionType.Send,
        ...
        yield* put(pushNotification({
            ...
            imageUrl: (_a = typeInfo.dapp.icon) !== null && _a !== void 0 ? _a : null,
            chainId,
        }));
    }
        ...
        yield* put(pushNotification({
            ...
            tokenAddress: typeInfo === null || typeInfo === void 0 ? void 0 : typeInfo.tokenAddress,
        }));
    }
}
export function shouldSuppressNotification({ tx, existingNotifications, }) {
    if (existingNotifications) {
        ...
        const existingBridgeNotification = existingNotifications.find((notification) => notification.type === AppNotificationType.Transaction &&
    ...
    const chainedTransaction = (tx.typeInfo.type === TransactionType.Approve || tx.typeInfo.type === TransactionType.Wrap) && tx.typeInfo.swapTxId;
    return chainedTransaction || staleTransaction;
}
//# sourceMappingURL=notificationWatcherSaga.js.map