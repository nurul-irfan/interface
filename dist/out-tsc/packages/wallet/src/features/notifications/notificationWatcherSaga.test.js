...
const txId = 'uuid-4';
export const createFinalizedTxAction = (typeInfo) => ({
    payload: {
...
//# sourceMappingURL=notificationWatcherSaga.test.js.map