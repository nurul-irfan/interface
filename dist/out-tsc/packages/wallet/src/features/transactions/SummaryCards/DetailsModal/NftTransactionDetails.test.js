...
describe('NftTransactionDetails Component', () => {
    it('renders NftTransactionDetails without error', () => {
        ...
        const tree = render(_jsx(NftTransactionDetails, { transactionDetails: mockTransaction, typeInfo: nftTypeInfo, onClose: onClose }), {
            preloadedState,
        });
        expect(tree).toMatchSnapshot();
    });
});
//# sourceMappingURL=NftTransactionDetails.test.js.map