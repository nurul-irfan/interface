...
import { TransactionDetailsContent, TransactionDetailsHeader, } from 'wallet/src/features/transactions/SummaryCards/DetailsModal/TransactionDetailsModal';
...
describe('TransactionDetails Components', () => {
    it('renders TransactionDetailsHeader without error', () => {
        ...
        const tree = render(_jsx(TransactionDetailsHeader, { transactionActions: transactionActions, transactionDetails: mockTransaction }), { preloadedState });
        expect(tree).toMatchSnapshot();
    });
    it('renders TransactionDetailsContent without error', () => {
        const onClose = jest.fn();
        const tree = render(_jsx(TransactionDetailsContent, { transactionDetails: mockTransaction, onClose: onClose }), {
            preloadedState,
        });
        expect(tree).toMatchSnapshot();
    });
    it('renders TransactionDetailsInfoRows without error with isShowingMore false', () => {
        const onClose = jest.fn();
        const tree = render(_jsx(TransactionDetailsInfoRows, { isShowingMore: false, transactionDetails: mockTransaction, onClose: onClose }), {
            preloadedState,
        });
        expect(tree).toMatchSnapshot();
    });
    it('renders TransactionDetailsInfoRows without error with isShowingMore true', () => {
        const onClose = jest.fn();
        const tree = render(_jsx(TransactionDetailsInfoRows, { isShowingMore: true, transactionDetails: mockTransaction, onClose: onClose }), {
            preloadedState,
        });
        expect(tree).toMatchSnapshot();
    });
});
//# sourceMappingURL=TransactionDetailsModal.test.js.map