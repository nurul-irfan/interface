...
import { FORMAT_DATE_MONTH_DAY, FORMAT_TIME_SHORT, useLocalizedDayjs, } from 'uniswap/src/features/language/localizedDayjs';
...
export function generateActivityItemRenderer(loadingItem, sectionHeaderElement, swapCallbacks, authTrigger) {
    return function ActivityItemComponent({ item, index }) {
 ...
 */
function getTransactionTypeVerbs(typeInfo, t) {
    var _a;
    const externalDappName = (_a = typeInfo.externalDappInfo) === null || _a === void 0 ? void 0 : _a.name;
...
export function getTransactionSummaryTitle(tx, t) {
    const { success, pending, failed, canceling, canceled, expired, insufficientFunds } = getTransactionTypeVerbs(tx.typeInfo, t);
    switch (tx.status) {
...
function useForceUpdateEveryMinute() {
...
export function useFormattedTime(time) {
...
export function useOnRetrySwap(transaction, swapCallbacks) {
    var _a;
    // For retrying failed, locally submitted swaps
    const swapFormState = swapCallbacks === null || swapCallbacks === void 0 ? void 0 : swapCallbacks.useSwapFormTransactionState(transaction.from, transaction.chainId, transaction.id);
    const latestSwapTx = swapCallbacks === null || swapCallbacks === void 0 ? void 0 : swapCallbacks.useLatestSwapTransaction(transaction.from);
    ...
    const shouldShowRetry = isTheLatestSwap || (Date.now() - transaction.addedTime < MAX_SHOW_RETRY_TIME && (swapCallbacks === null || swapCallbacks === void 0 ? void 0 : swapCallbacks.onRetryGenerator));
    const onRetry = (_a = swapCallbacks === null || swapCallbacks === void 0 ? void 0 : swapCallbacks.onRetryGenerator) === null || _a === void 0 ? void 0 : _a.call(swapCallbacks, swapFormState);
