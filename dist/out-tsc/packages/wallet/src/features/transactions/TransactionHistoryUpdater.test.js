...
import { TransactionHistoryUpdater, getReceiveNotificationFromData, } from 'wallet/src/features/transactions/TransactionHistoryUpdater';
...
describe(TransactionHistoryUpdater, () => {
    ...
    it('skips rendering when no accounts available', () => {
        ...
        const tree = render(_jsx(TransactionHistoryUpdater, {}), {
...
describe(getReceiveNotificationFromData, () => {
    it('returns app notification object with new receive', () => {
        ...
        expect(notification).toEqual(receiveCurrencyTxNotification({
    ...
    it('returns undefined if no receive txns found', () => {
        ...
        const txnDataWithoutReceiveTxns = { portfolios };
        // Ensure all transactions will be "new" compared to this
        const newTimestamp = 1;
...
//# sourceMappingURL=TransactionHistoryUpdater.test.js.map