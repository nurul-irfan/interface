...
import { Chain, Currency, NftStandard, TransactionType as RemoteTransactionType, TokenStandard, TransactionDirection, TransactionStatus, } from 'uniswap/src/data/graphql/uniswap-data-api/__generated__/types-and-hooks';
...
const MOCK_721_MINT_WTIH_NATIVE = {
    ...RESPONSE_BASE,
    details: {
        ...RESPONSE_BASE.details,
        type: RemoteTransactionType.Mint,
...
describe(extractTransactionDetails, () => {
    ...
    it('Approve', () => {
        ...
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.Approve);
    });
    it('Send', () => {
        const txn = extractTransactionDetails(MOCK_ERC20_SEND);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.Send);
    });
    it('Receive', () => {
        const txn = extractTransactionDetails(MOCK_ERC20_RECEIVE);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.Receive);
    });
    it('Swap token', () => {
        const txn = extractTransactionDetails(MOCK_ERC20_SWAP);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.Swap);
    });
    it('NFT buy', () => {
        const txn = extractTransactionDetails(MOCK_NFT_BUY);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.NFTTrade);
    });
    it('Mint', () => {
        const txn = extractTransactionDetails(MOCK_721_MINT);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.NFTMint);
    });
    it('OnRamp transfer', () => {
        const txn = extractTransactionDetails(MOCK_ONRAMP_TRANSFER);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.OnRampTransfer);
    });
    it('OnRamp purchase', () => {
        const txn = extractTransactionDetails(MOCK_ONRAMP_PURCHASE);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.OnRampPurchase);
    });
    it('Unknown', () => {
        const txn = extractTransactionDetails(RESPONSE_BASE);
        expect(txn === null || txn === void 0 ? void 0 : txn.typeInfo.type).toEqual(TransactionType.Unknown);
    });
});
