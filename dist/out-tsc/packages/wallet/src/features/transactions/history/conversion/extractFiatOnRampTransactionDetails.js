...
function parseOnRampTransaction(transaction) {
    ...
    const typeInfo = transaction.sourceCurrencyCode === transaction.destinationCurrencyCode
        ? {
            ...transactionInfo,
...
function statusToTransactionInfoStatus(status) {
    switch (status) {
        case 'FAILED':
        case 'ERROR':
        case 'VOIDED':
...
export function extractFiatOnRampTransactionDetails(transaction) {
    try {
...
export function extractOnRampTransactionDetails(transaction) {
    var _a;
    if ((transaction === null || transaction === void 0 ? void 0 : transaction.details.__typename) !== TransactionDetailsType.OnRamp) {
        return null;
    }
...
//# sourceMappingURL=extractFiatOnRampTransactionDetails.js.map