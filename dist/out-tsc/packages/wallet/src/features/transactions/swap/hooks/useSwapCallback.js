...
export function useSwapCallback() {
    ...
    const { data: portfolioData } = usePortfolioTotalValue({
        address: accountMeta === null || accountMeta === void 0 ? void 0 : accountMeta.address,
        fetchPolicy: 'cache-first',
    });
    return useCallback((args) => {
        var _a, _b;
        const { account, swapTxContext, txId, onSuccess, onFailure, currencyInAmountUSD, currencyOutAmountUSD, isAutoSlippage, isFiatInputMode, } = args;
        ...
        const blockNumber = (_b = (_a = getClassicQuoteFromResponse(trade === null || trade === void 0 ? void 0 : trade.quote)) === null || _a === void 0 ? void 0 : _a.blockNumber) === null || _b === void 0 ? void 0 : _b.toString();
    ...
    }, [appDispatch, formatter, portfolioData === null || portfolioData === void 0 ? void 0 : portfolioData.balanceUSD, swapStartTimestamp, trace]);
}
//# sourceMappingURL=useSwapCallback.js.map