...
import { QueuedOrderStatus, TransactionOriginType, TransactionStatus, } from 'uniswap/src/features/transactions/types/transactionDetails';
...
export function* submitUniswapXOrder(params) {
    const { quote, routing, permit, approveTxHash, wrapTxHash, txId, chainId, typeInfo, account, analytics, onSuccess, onFailure, } = params;
    ...
    const order = {
        ...
        orderHash,
        id: txId !== null && txId !== void 0 ? txId : createTransactionId(),
        chainId,
        typeInfo,
...
//# sourceMappingURL=submitOrderSaga.js.map