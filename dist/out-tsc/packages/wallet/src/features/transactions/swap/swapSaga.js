...
export function* approveAndSwap(params) {
    try {
        ...
        if (approveTxRequest) {
            const typeInfo = {
                ...
                swapTxId: txId,
                gasEstimates: gasFeeEstimation === null || gasFeeEstimation === void 0 ? void 0 : gasFeeEstimation.approvalEstimates,
            };
        ...
        const typeInfo = tradeToTransactionInfo(swapTxContext.trade, transactedUSDValue, gasFeeEstimation === null || gasFeeEstimation === void 0 ? void 0 : gasFeeEstimation.swapEstimates);
        // Swap Logic - UniswapX
        if (isUniswapX) {
            ...
            if (wrapTxRequest) {
                ...
                const wrapResponse = yield* wrap({
                    ...
                    gasEstimates: gasFeeEstimation === null || gasFeeEstimation === void 0 ? void 0 : gasFeeEstimation.wrapEstimates,
                });
                wrapTxHash = wrapResponse === null || wrapResponse === void 0 ? void 0 : wrapResponse.transactionResponse.hash;
            }
...
export const { name: swapSagaName, wrappedSaga: swapSaga, reducer: swapReducer, actions: swapActions, } = createMonitoredSaga(approveAndSwap, 'swap');
export function* shouldSubmitViaPrivateRpc(chainId) {
...
//# sourceMappingURL=swapSaga.js.map