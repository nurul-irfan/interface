...
import { approveAndSwap, shouldSubmitViaPrivateRpc } from 'wallet/src/features/transactions/swap/swapSaga';
...
jest.mock('uniswap/src/features/transactions/swap/utils/trade', () => {
    return {
        tradeToTransactionInfo: () => mockTransactionTypeInfo,
    };
});
...
const nonce = 1;
const expectedSendApprovalParams = {
...
describe(approveAndSwap, () => {
    ...
    it('sends a uniswapx order', async () => {
        const expectedSubmitOrderParams = {
...
//# sourceMappingURL=swapSaga.test.js.map