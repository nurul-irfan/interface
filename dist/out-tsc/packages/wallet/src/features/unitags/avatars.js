...
export function isLocalFileUri(imageUri) {
...
export async function uploadFileToS3(imageUri, creds) {
 ...
 */
export async function uploadAndUpdateAvatarAfterClaim({ username, imageUri, account, signerManager, }) {
    try {
...
export const tryUploadAvatar = async ({ avatarImageUri, avatarUploadUrlResponse, avatarUploadUrlLoading, }) => {
    const needsAvatarUpload = !!avatarImageUri && isLocalFileUri(avatarImageUri);
    const isPreSignedUrlReady = !avatarUploadUrlLoading && !!(avatarUploadUrlResponse === null || avatarUploadUrlResponse === void 0 ? void 0 : avatarUploadUrlResponse.preSignedUrl) && !!(avatarUploadUrlResponse === null || avatarUploadUrlResponse === void 0 ? void 0 : avatarUploadUrlResponse.s3UploadFields);
