...
import { NATIVE_ANALYTICS_ADDRESS_VALUE, areCurrencyIdsEqual, buildCurrencyId, buildNativeCurrencyId, currencyAddress, currencyId, currencyIdToAddress, currencyIdToChain, currencyIdToGraphQLAddress, getCurrencyAddressForAnalytics, isNativeCurrencyAddress, } from 'uniswap/src/utils/currencyId';
...
describe(currencyIdToAddress, () => {
    ...
    it('returns correct address for native asset', () => {
        expect(currencyIdToAddress(`1-${getNativeAddress(UniverseChainId.Mainnet)}`)).toEqual(getNativeAddress(UniverseChainId.Mainnet));
    });
});
describe(currencyIdToGraphQLAddress, () => {
    ...
    it('returns POL address for Polygon native asset', () => {
        expect(currencyIdToGraphQLAddress('137-0x0000000000000000000000000000000000001010')).toEqual('0x0000000000000000000000000000000000001010');
    });
...
//# sourceMappingURL=currencyId.test.js.map